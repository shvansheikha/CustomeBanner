...
public class BadgeView extends AppCompatTextView {
    ...
    public void setBadgeCount(int count) {
        ...
        setMinHeight(dip2Px(18));
        setMinWidth(dip2Px(18));
        setPadding(dip2Px(5), dip2Px(1), dip2Px(5), dip2Px(1));
        setBackground(dip2Px(9), Color.parseColor("#d3321b"));
    }
    ...
    public void setEmptyBadge() {
        ...
        setBackground(dip2Px(5), Color.parseColor("#d3321b"));
    }

    public void setEmptySmallerBadge() {
        setText("");
        setWidth(dip2Px(4));
        setHeight(dip2Px(4));
        setPadding(dip2Px(0), dip2Px(0), dip2Px(0), dip2Px(0));
        setBackground(dip2Px(2), Color.parseColor("#d3321b"));
    }
    ...
    public void setBadgeMargin(int topDipMargin, int leftDipMargin, int bottomDipMargin, int rightDipMargin) {
        LayoutParams params = (LayoutParams) getLayoutParams();
